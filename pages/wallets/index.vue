    ...
    return {
      headers: [
        ...
        },
        {
          ...
          expand: true,
          rules: ["required"],
          help: "https://docs.rdwv.ai/your-first-invoice#creating-a-wallet",
        ...
        },
        {
          text: "Label",
          value: "label",
          help: "https://docs.rdwv.ai/support-and-community/faq/stores-faq#how-do-i-change-my-payment-methods-name",
        },
        {
          text: "Hint",
          value: "hint",
          expand: true,
          help: "https://docs.rdwv.ai/support-and-community/faq/stores-faq#how-do-i-display-a-checkout-hint-for-customers",
        },
        {
